...
public sealed class UsersController(ApplicationDbContext dbContext, UserContext userContext, LinkService linkService) : ControllerBase
{
    ...
    {
        List<Entities.User> users = await dbContext.Users.ToListAsync();
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult> UpdateProfile(UpdateUserProfileDto dto, IValidator<UpdateUserProfileDto> validator)
    {
